...
<script>
    ...
    if (!savedTime) {
// يتم تعيين الوقت الافتراضي إذا لم يتم تعيين قيمة مخزنة مسبقًا في localStorage
        savedTime = '2023-03-06T12:00:00'; // تغيير 'savedTime' إلى الوقت الذي تريد استخدامه من حقل البيانات
    }

    function updateCountdown() {
        const currentTime = new Date().getTime();
        const timeDiff = new Date(savedTime) - currentTime;
...
// يتم تخزين الوقت المحدد في localStorage للحفاظ عليه حتى بعد تحديث الصفحة
        localStorage.setItem('savedTime', savedTime);
    }

    updateCountdown(); // يتم استدعاء هذه الوظيفة لأول مرة لتحديث العداد عند تحميل الصفحة
    setInterval(updateCountdown, 1000); // يتم استدعاء هذه الوظيفة بانتظام لتحديث العداد كل ثانية واحدة
</script>
