    ...
    <div class="card card-statistics h-100">
        <div class="card-body">
            ...
            <br><br>
                ...
                <form action="{{ route('admin.Filter_Classes') }}" method="POST">
                    @csrf
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <!-- edit_form -->
                                            <form action="{{ route('admin.classrooms.update', 'test') }}" method="post">
                                                {{ method_field('patch') }}
                                                @csrf
                                                <div class="row">
                                                    <div class="col">
                            ...
                            <div class="modal fade" id="delete{{ $My_Class->id }}" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ route('admin.classrooms.destroy', 'test') }}"
                                                  method="post">
                                                @method('DELETE')
                                                @csrf
