        ...
        <div class="card card-statistics h-100">
            <div class="card-body">
                <div class="col-xl-12 mb-30">
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            <a href="{{ route('admin.student.online_classes.create') }}" class="btn btn-success" role="button"
                                aria-pressed="true">اضافة حصة اونلاين جديدة</a>
                            <a class="btn btn-warning" href="{{ route('admin.student.indirect.create.admin') }}">اضافة حصة اوفلاين
                                جديدة</a>
                                ...
                                <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                    ...
                                    <tbody>
                                        @foreach ($online_classes as $online_classe)
                                            ...
                                            @include('admin.pages.online_classes.delete')
                                        @endforeach
                                </table>
                            </div>
                        </div>
