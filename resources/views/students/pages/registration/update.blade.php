            ...
            <div class="card-body">
                ...
                <form method="post" action="{{ route('teacher.complete_register.update', $teacher->id) }}"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="nal_id">{{ trans('Teacher_trans.specialization') }} : <span
                                        class="text-danger">*</span></label>
                                <select class="custom-select mr-sm-2" name="Specialization_id">
                                    <option selected disabled>{{ trans('Parent_trans.Choose') }}...</option>
                                    @foreach ($Specialization as $Specia)
                                        <option value="{{ $Specia->id }}">{{ $Specia->Name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
