    ...
    <ul class="nav navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown ">
            ...
            <div class="dropdown-menu dropdown-menu-right dropdown-big dropdown-notifications">
                <div class="dropdown-header notifications">
                    ...
                    <span
                        class="badge badge-pill badge-warning">{{ 0 }}</span>
                </div>
                <div class="dropdown-divider"></div>
                @foreach (auth('teacher')->user()->unreadnotifications as $notify)

                    <a href="#" class="dropdown-item">{{ $notify->data['data'] }} <small
                            class="float-right text-muted time">{{ $notify->created_at->diffForHumans() }}</small> </a>
                @endforeach
        ...
        <li class="nav-item dropdown mr-30">
            <a class="nav-link nav-pill user-avatar" data-toggle="dropdown" href="#" role="button"
                aria-haspopup="true" aria-expanded="false">
                <img src="{{ URL::asset('assets/images/undraw_male_avatar_g98d.svg') }}" alt="avatar">
