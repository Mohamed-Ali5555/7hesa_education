...
{{-- @section('page-header') --}}
<!-- breadcrumb -->
@section('PageTitle', 'تعديل السؤال ')
                            ...
                            <div class="form-row">
                                <div class="col-md-12">
                                    <div>
                                        ...
                                        <input type="hidden" value="{{ $question->id }}" name="quizz_id">
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <select name="level" id="level">
                                            @foreach ($levels as $level)
                                                <option value="{{ $level }}" @selected(old('level',$question->level) == $level )>{{ trans("app.levels.{$level}") }}</option>
                                            @endforeach
                                        </select>
                                        <input type="hidden" value="{{ $question->id }}" name="quizz_id">
                                    </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea name="desc" id="desc" class="form-control form-control-alternative">{{ old('desc',$question->description) }}</textarea>
                                    <div class="error"></div>
                                </div>
