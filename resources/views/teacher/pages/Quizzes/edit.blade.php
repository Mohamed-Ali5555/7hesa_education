                    ...
                    <div class="col-xs-12">
                        <div class="col-md-12">
                            ...
                            <form action="{{route('teacher.quizzes.update','test')}}" method="post">
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        <label for="title">مدة الاختبار</label>
                                        <input type="text" name="time" class="form-control timepicker" value="{{$quizz->time}}" placeholder="00:00">
                                    </div>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-6">
                                      ...
                                      <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="package_id">package_id  : <span class="text-danger">*</span></label>
                                            <select class="custom-select mr-sm-2" name="package_id">
                                                @foreach($packages as $package)
                                                    <option value="{{ $package->id }}" {{$package->id == $quizz->package_id ? "selected":""}}>{{ $package->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
