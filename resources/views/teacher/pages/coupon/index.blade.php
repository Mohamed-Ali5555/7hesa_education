...
<div class="row">
    <div class="col-md-12 mb-30">
        <div class="card  h-100">
            <div class="card-body">
                <a href="{{ route('teacher.coupon.create') }}" class="btn btn-success btn-sm" role="button"
                            ...
                            @foreach ($coupons as $coupon)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('teacher.coupon.edit', $coupon->id) }}"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="{{route('teacher.coupon.destroy',$coupon->id)}}" method="post">
                                                        @csrf
                                                        @method('DELETE')
