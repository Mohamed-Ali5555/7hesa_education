    ...
    <div class="col-6">
        <div class="form-group">
            ...
            <select id="type" class="custom-select mr-sm-2" name="type">
                <option @selected(old('type')) value="percent">نسبة مئويه</option>
                <option @selected(old('type')) value="fixed">مبلغ ثابت</option>
            </select>
            @error('type')
...
<div class="col-6">
    ...
    <input type="date" id="end_date" required name="end_date" value="{{ old('end_date') }}"
        class="form-control">
    @error('end_date')
        <p class="text-danger">{{ $message }}
    </div>
...
<div class="col-6">
    ...
    <input type="number" id="limit" required name="limit" value="{{ old('limit') }}"
        class="form-control">
    @error('limit')
        <p class="text-danger">{{ $message }}
    </div>
...
<div class="col-6">
    <label for="student_limit">student_limit</label>
    <input type="number" id="student_limit" required name="student_limit"
        value="{{ old('student_limit') }}" class="form-control">
    @error('student_limit')
        <p class="text-danger">{{ $message }}
    </div>
@enderror
