    ...
    <form method="post" action="{{ route('teacher.attendance') }}" autocomplete="off">
        ...
        <table id="datatable" class="table  table-hover table-sm table-bordered p-0" data-page-length="50"
            ...
            <tr>
                ...
                <th class="alert-dark">{{ trans('Students_trans.name') }}</th>
                <th class="alert-dark">{{ trans('Students_trans.email') }}</th>
                <th class="alert-dark">{{ trans('Students_trans.gender') }}</th>
                <th class="alert-dark">{{ trans('Students_trans.Grade') }}</th>
                <th class="alert-dark">{{ trans('Students_trans.classrooms') }}</th>
                <th class="alert-dark">{{ trans('Students_trans.section') }}</th>
                <th class="alert-dark">الحضور والغياب</th>
            </tr>
            </thead>
            <tbody>
